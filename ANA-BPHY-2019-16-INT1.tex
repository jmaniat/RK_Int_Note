...
\input{ANA-BPHY-2019-16-INT1-metadata}
...
\label{sec:trigger}
%-------------------------------------------------------------------------------
\input{tex/trigger_electrons.tex}
\input{tex/trigger_muons.tex}
...
\input{tex/preselection.tex}

\subsection{Multiple Candidates}
\input{tex/candselection.tex}

\subsection{Continuum Reduction Selection}
\input{tex/contselection.tex}

\subsection{Continuum Reduction Selection in muon channel}
\input{tex/contselection_muon.tex}
...
\input{tex/discriminatingvariables.tex}
\section{Fakes Background}
\label{sec:FakesBackground}
\input{tex/fakeEstimation}
%-------------------------------------------------------------------------------
\section{Signal Characterisation and Fit Studies}
\label{sec:signal}
%-------------------------------------------------------------------------------
\input{tex/signal.tex}
...
\label{sec:app:data}
%-------------------------------------------------------------------------------
\input{tex/app-data.tex}

\clearpage
\section{(Pileup and) Prescale Reweighting for Electron Triggers}
\label{sec:prw-for-electron-triggers}
\input{tex/app-prw-electron-triggers.tex}

\clearpage 
\section{Extensive studies on backgrounds}
\label{sec:app:bkgdvij}
\input{tex/app-background-misc.tex}

\clearpage

\section{Computation of the discriminating variables}
\label{sec:app:compdiscriminatingvars}
\input{tex/app-discriminatingvariables.tex}

\clearpage

\section{Studies for Daniel Hans Munk's master thesis}
\label{sec:app:daniel}
\input{tex/app-daniel.tex}

\clearpage

\section{Improved Electron Track Reconstruction Using EMCal Cluster Information in the GSF Re-fit}
\label{sec:app:gsf-emcal}
\input{tex/app-gsf-emcal.tex}

\section{Systematic Bias in Evaluation of the Faking Probabilities}
\label{sec:app:fake-systematics}
\input{tex/app-fake-systematics}

\section{Kinematic Corrections in Fake Estimation}
\label{sec:app:kinematic-corrections}
\input{tex/app-kinematic-correction}

\subsection{Electron Reconstruction}
\label{sec:app:prw-math}
\input{tex/app-prw-math}
\end{document}
