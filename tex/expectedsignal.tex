...
\begin{align}
  n_{{\textrm Non},B+\bar B}^{\textrm MC.sel}_{ee} = \\
  n_{{\textrm Res},B+\bar B}^{\textrm MC.sel}_{ee} = \\
  n_{{\textrm Non},B+\bar B}^{\textrm MC.sel}_{\mu\mu} = \\
  n_{{\textrm Res},B+\bar B}^{\textrm MC.sel}_{\mu\mu} = 
\end{align}
