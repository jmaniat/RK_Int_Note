...
These backgrounds are expected to form a peaking structure under the signal $B-$mass, particularly in the high$-q^2$ bin as can be seen in \figref{fig:peaking-real-background-mc}. %
