...
\begin{figure}[]
    ...
    \textcolor{red}{need to update this plot with better quality and pulls
    on the low sideband.}}
    \label{fig:CorrAndSBFit}
\end{figure}
...
as the region $m_{B} \in [3.5, 4.0] \cup [5.7, 6.5]$\,GeV. Fig. \ref{fig:CorrAndSBFit}
...
Fig~\ref{fig:PunziScans} shows the Punzi significance scan for a few slices of the grid search.
