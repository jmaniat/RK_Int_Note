...
The percentage of events with more than one four-particle sets before the preselection is about $67.1\%$ ($66.8\%$)
for the non-resonant (resonant) sample for the electron final state,
while the same percentage after the preselection is down to about $44.3\%$ ($44.9\%$)
for the non-resonant (resonant) sample for the electron final state.
...
\hline
~~~~non-resonant signal & 44.3 & 63.2\\
~~~~resonant $J/\psi K^*$ & 44.9 & 63.5\\
\hline\hline
muon final states       & & \\
\hline
